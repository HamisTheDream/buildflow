      ...
      <form class="space-y-4" @submit.prevent="form.post('/owner/admins')">
        <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
          <div>
            ...
            <input v-model="form.name" class="mt-1 w-full rounded-lg border p-2 text-sm" />
          ...
          <div>
            ...
            <input v-model="form.email" class="mt-1 w-full rounded-lg border p-2 text-sm" />
          ...
          <div class="md:col-span-2">
            ...
            <input v-model="form.password" type="password" class="mt-1 w-full rounded-lg border p-2 text-sm" />
          ...
          <div>
            ...
            <select v-model="form.is_super" class="mt-1 w-full rounded-lg border p-2 text-sm">
        ...
        <div class="rounded-xl border p-4">
          ...
          <input v-model="form.audit_reason" class="mt-2 w-full rounded-lg border p-2 text-sm" placeholder="e.g. Hired support staff" />
        </div>
