      ...
      <div class="space-y-6">
         ...
         <div class="rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-200">
             <div class="flex items-center justify-between mb-4">
                 ...
                 <button type="button" @click="clearFilters" class="text-xs text-indigo-600 hover:text-indigo-800 font-medium">Reset</button>
             </div>
             <div class="space-y-3">
                 ...
                 <button type="button" @click="applyFilters" class="w-full rounded-md bg-gray-100 py-2 text-sm font-medium text-gray-700 hover:bg-gray-200">Apply Filter</button>
             </div>
         </div>
      </div>
