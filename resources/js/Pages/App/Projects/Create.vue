        ...
        <div class="rounded-2xl border border-gray-200 bg-white shadow-card">
          ...
          <form @submit.prevent="submit" class="divide-y divide-gray-100">
            ...
            <div class="flex flex-col-reverse sm:flex-row items-center justify-end gap-3 px-6 py-5 bg-gray-50 rounded-b-2xl">
              ...
              <button
                type="submit"
                class="w-full sm:w-auto rounded-lg bg-brand-600 px-4 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-brand-700 transition disabled:opacity-50 disabled:cursor-not-allowed"
