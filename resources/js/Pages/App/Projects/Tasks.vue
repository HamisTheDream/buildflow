  ...
  <ProjectLayout :project="project" active="tasks">
    ...
    <div class="space-y-6">
        <div class="flex items-center justify-between">
             ...
             <div v-if="project?.id">
                 <button type="button" v-if="canManage" @click="openCreate()" class="inline-flex items-center gap-2 rounded-lg bg-brand-600 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-brand-700 transition">
          ...
          <div class="flex items-start justify-between gap-4">
            ...
            <div class="flex flex-col items-end gap-2">
              ...
              <div v-if="canManage" class="flex items-center gap-3 mt-2 opacity-0 group-hover:opacity-100 transition-opacity">
                <button type="button" @click="openEdit(t)" class="text-sm font-medium text-gray-500 hover:text-gray-700">Edit</button>
                 <button type="button" @click="deleteTask(t)" class="text-sm font-medium text-red-500 hover:text-red-700">Delete</button>
              </div>
            </div>
          </div>
        </div>
