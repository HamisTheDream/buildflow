      ...
      <div class="mt-6 grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <div class="rounded-xl bg-white p-6 shadow">
          ...
          <form v-else class="mt-4 space-y-3" @submit.prevent="submitInvite">
            ...
            <button
              class="w-full flex justify-center items-center gap-2 rounded-lg bg-indigo-600 px-4 py-2 text-sm font-medium text-white hover:bg-indigo-700 disabled:opacity-50"
            ...
            >
              ...
              <span v-else>Create invite link</span>
            </button>
          </form>
        </div>
