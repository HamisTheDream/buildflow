      ...
      <div class="flex h-full flex-col">
        ...
        <div class="border-t border-slate-800 p-4">
          ...
          <form method="post" action="/owner/logout" class="mt-3">
            ...
            <button type="button" class="flex w-full items-center justify-center gap-2 rounded-lg bg-slate-800 px-3 py-2 text-sm font-medium text-gray-400 transition hover:bg-slate-700 hover:text-white">
